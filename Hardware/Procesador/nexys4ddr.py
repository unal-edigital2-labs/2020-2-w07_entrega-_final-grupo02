...
_io = [
    ...
    #PWM
    ("pwm",  0, Pins("F3"), IOStandard("LVCMOS33")),
    #Ultrasonido
    ("ECHO",  0, Pins("G1"), IOStandard("LVCMOS33")),
    ("trigg",  0, Pins("G3"), IOStandard("LVCMOS33")),
    #CAMARA
    ...
    ("uart2", 0,
        Subsignal("tx", Pins("G4")),
        Subsignal("rx", Pins("H2")),
        IOStandard("LVCMOS33"),
    ),

    #Infrarojos
    ("infrarrojos",  0, Pins("G6"), IOStandard("LVCMOS33")),
    ("infrarrojos",  1, Pins("V10"), IOStandard("LVCMOS33")),
    ("infrarrojos",  2, Pins("U11"), IOStandard("LVCMOS33")),    
    
    #Botones de selección
    ("btnI", 0, Pins("P18"), IOStandard("LVCMOS33")),
    ("btnH", 0, Pins("M18"), IOStandard("LVCMOS33")),
