...
# led:0
set_property LOC V11 [get_ports {led0}]
set_property IOSTANDARD LVCMOS33 [get_ports {led0}]

# led:1
set_property LOC V12 [get_ports {led1}]
...
# btnI:0
set_property LOC P18 [get_ports {btnI}]
set_property IOSTANDARD LVCMOS33 [get_ports {btnI}]

# btnH:0
set_property LOC M18 [get_ports {btnH}]
set_property IOSTANDARD LVCMOS33 [get_ports {btnH}]

# uart1:0.tx
set_property LOC H1 [get_ports {uart1_tx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart1_tx}]

# uart1:0.rx
set_property LOC H4 [get_ports {uart1_rx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart1_rx}]

# uart2:0.tx
set_property LOC G4 [get_ports {uart2_tx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart2_tx}]

# uart2:0.rx
set_property LOC H2 [get_ports {uart2_rx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart2_rx}]

# infrarrojos:0
set_property LOC G6 [get_ports {infrarrojos0}]
set_property IOSTANDARD LVCMOS33 [get_ports {infrarrojos0}]

# infrarrojos:1
set_property LOC V10 [get_ports {infrarrojos1}]
set_property IOSTANDARD LVCMOS33 [get_ports {infrarrojos1}]

# infrarrojos:2
set_property LOC U11 [get_ports {infrarrojos2}]
set_property IOSTANDARD LVCMOS33 [get_ports {infrarrojos2}]

# pwm:0
set_property LOC F3 [get_ports {pwm}]
